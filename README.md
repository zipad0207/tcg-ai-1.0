...
[![Interactive Web Replay](https://img.shields.io/badge/Web%20Replay-HTML5%20Player-6f42c1)](PythonApplication23/battle_replay.html)
...
graph TD
    ...
    C --> D[training_metrics_baseline.json 遥测数据提取]
    D --> E{偏离 50% 平衡线 > 5%?}
    E -- 是 (31.2% vs 68.8%) --> F[DeepSeek 数值策划微调: auto_balancer_deepseek.py]
    F -->|输出调优卡池: cards_config_tuned.json| B
    E -- 达到均衡 (46.1% vs 53.9%) --> G[导出学术对比大图 figure_comparison.png]
