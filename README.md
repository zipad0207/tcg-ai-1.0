...
以下为通过强化学习出牌遥测数据驱动，经由 LLM 规则决策引擎实施的单卡微调补丁明细：

| 卡牌 ID | 卡牌名称 | 所属阵营 | 类型 | 调试前数值 (Baseline) | 调试后数值 (Tuned) | 变动属性 | 数值策划调优机理与博弈意图 |
| :---: | :--- | :---: | :---: | :--- | :--- | :---: | :--- |
| **100** | **赤红突击手** | 红方 | 随从 | 费用: 1 \| **DP: 2**<br>词条: `DEATH_DRAW_1` | 费用: 1 \| **DP: 1**<br>词条: `DEATH_DRAW_1` | 基础 DP -1 | 削弱1费站场战力，平滑前期快攻滚雪球压迫感 |
| **103** | **射线** | 红方 | 法术 | 费用: 1 \| **伤害: 3** | 费用: 1 \| **伤害: 2** | 法术伤害 -1 | 降低低费直伤直接蒸发防守单位的穿透效率 |
| **104** | **切割者** | 红方 | 随从 | 费用: 2 \| **DP: 3**<br>词条: `DEGRADE_2` | 费用: 2 \| **DP: 2**<br>词条: `DEGRADE_2` | 基础 DP -1 | 抑制自带削弱（DEGRADE）核心怪的单兵穿防能力 |
| **105** | **掠夺者** | 红方 | 随从 | **费用: 4** \| DP: 4<br>词条: `BONUS_SCORE_1` | **费用: 5** \| DP: 4<br>词条: `BONUS_SCORE_1` | 费用 Cost +1 | 延后双倍得分斩杀点的爆发回合，留出博弈窗口 |
| **200** | **蔚蓝卫士** | 蓝方 | 随从 | 费用: 2 \| DP: 2<br>词条: **`FORTIFY_1`** | 费用: 2 \| DP: 2<br>词条: **`FORTIFY_2`** | 坚守增益 +1 | 提升防守驻军实际 DP 至 4 点，抵御起手冲锋 |
| **203** | **防御！** | 蓝方 | 法术 | 费用: 2 \| **护甲增益: 1** | 费用: 2 \| **护甲增益: 2** | 法术防御 +1 | 增强应急响应法术的防守韧性与即时反制手段 |
| **205** | **藤甲兵** | 蓝方 | 随从 | 费用: 4 \| DP: 4<br>词条: **`FORTIFY_1`** | 费用: 4 \| DP: 4<br>词条: **`FORTIFY_2`** | 坚守增益 +1 | 巩固中费核心阵线的承伤阈值，阻止合击强杀 |
| **206** | **火铳手** | 蓝方 | 随从 | 费用: 3 \| DP: 3<br>词条: **`SUPPORT_ATK_1`** | 费用: 3 \| DP: 3<br>词条: **`SUPPORT_ATK_2`** | 支援战力 +1 | 增加驻防时的火力光环，给予防守方反击能力 |
